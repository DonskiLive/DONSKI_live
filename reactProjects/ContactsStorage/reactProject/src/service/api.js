...
export const addNewContact = async(contact)=>{
    try{
        const response = await client.post('/api/my-contacts', contact) // axios transfer in JSON format
...
export const updateMyContact = async(contact)=>{
    try{
        const response = await client.put('/api/my-contacts', contact) // axios transfer in JSON format
        console.log('modified success', response)
        return response.data
    }catch(error){
        console.dir(error)
        throw new Error(error.response.data.message)
...
export const deleteMyContact = async(id)=>{
    console.log(id)
    try{
        await client.delete(`/api/my-contacts/${id}`) // axios transfer in JSON format
