...
export default class App extends React.Component {
  ...
  closeClickHandler = () => {
    this.setState({ ...this.state, currentBook: null }) // ...this.state - разварачиваем всё что в state а через запитую обращаемся к полю развёрнутого обьекта. таким методом можно добавлять поля в обьект state, через запитую
  }
