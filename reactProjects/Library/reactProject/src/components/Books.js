...
const Books = ({ loading, books, currentLevel }) => {
    ...
    return (
        ...
        {loading ? <div className="text-center my-5">
            ...
            {books.length ?  <h1 className='text-center my-3'>Library:</h1> : <h1 className='text-center my-3'>No books found <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-emoji-frown mb-2 ms-2" viewBox="0 0 16 16">
