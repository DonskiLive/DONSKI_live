...
const UserAlbums = () => {
    ...
    return (
        <div className="col-8 p-3 my-2">
            ...
            <div className='row row-cols-1 row-cols-md-3 g-4 p-2 justify-content-center'>
                {userAlbums.map(album => <UserAlbum key={album.id} album={album} setCurrentAlbum={setCurrentAlbum} currentAlbum={currentAlbum}/>)}
            </div>
            <button className="w-100 btn btn-success mt-2"
                type="button"
