const audioCorrect = new Audio('./src/correct.mp3'),
    audioFault = new Audio('./src/fault.mp3'),
    audioSad = new Audio('./src/end.mp3'),
    audioGood = new Audio('./src/good.mp3'),
    audioSuper = new Audio('./src/super.mp3'),
    audioWindowChange = new Audio('./src/window-change.mp3'),
